<section class="o-section c-section--goals">
	<div class="o-section__wrapper">
		<div class="c-goals">
			...
			<p>
				در موسسه نسا قلیخانی، ما به دنبال ایجاد تحول در دنیای حسابداری و مالی هستیم. اهداف ما نه تنها به خدماتی
				که ارائه می‌دهیم محدود نمی‌شود، بلکه شامل تعهــد ما به رشــد و موفقیت مشتریان‌مان نیز می‌باشد.
				<br>
				اینجا به مهم‌ترین اهداف ما اشاره می‌کنیم:
			</p>
			<ul class="m-0 p-0 d-flex space-between flex-wrap">
				<li class="d-flex">
					<div class="c-goals__img d-flex"><img class="w-100"  src="<?php echo get_template_directory_uri(); ?>/assets/images/goal-1.svg" alt="">
					</div>
